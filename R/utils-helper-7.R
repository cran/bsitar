 ...
 */"
  ...
  if (select_model == 'sitar' | select_model == 'rcs') {
    ...
    if(add_fast == "") {
      ...
      # For multivariate model, this approach won't work, TODO...
      if(ii > 1) {
  ...
  if (grepl("^pb", select_model) |
    ...
    # a - asymtote b - size at theta c - s0 d - s1 e - time (theta)
    if (select_model == 'pb1') {
    ...
    # a - asymtote b - size at theta c - s0 d - s1 e - time (theta) f - gamma
    if (select_model == 'pb2') {
    ...
    # a - asymptote b - rate constant c - time at midpoint
    ...
    # a - asymtote b - size at theta c - s0 d - theta1 e - s1 f - theta2
    ...
    # a - size at infancy b - rate at infancy c - time at infancy
  ...
  extract_r_fun_from_scode <- function(xstaring, 
      ...
      xstaring <- gsub("matrixXp" , "Xp", xstaring, fixed = T)
