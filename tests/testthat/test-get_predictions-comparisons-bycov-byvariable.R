...
test_that("test-marginals-slopes-bycov-byvariable", {
  ...
  # Even by covariate cov, variables remains xvar only whereas by includes cov
  ...
  # need to change by
  marginaleffects_plot_slopes_args[['by']] <- by
  marginaleffects_plot_slopes_args[['condition']] <- NULL
  ...
  marginaleffects_plot_slopes_args[['condition']] <- by
